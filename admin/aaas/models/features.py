...
Per AAAS_ADMIN_SRS.md Section 4.3.1
"""
...
from admin.aaas.models.choices import FeatureCategory, QuotaEnforcementPolicy
from admin.aaas.models.tiers import SubscriptionTier


class AaasFeature(models.Model):
...
class TierFeature(models.Model):
    ...
    feature = models.ForeignKey(
        AaasFeature, on_delete=models.CASCADE, related_name="tier_assignments"
    )
...
class FeatureProvider(models.Model):
    ...
    feature = models.ForeignKey(AaasFeature, on_delete=models.CASCADE, related_name="providers")
