"""
Django Management Command: seed_aaas_data
Seed initial AAAS data including tiers, features, roles, and rate limits.
...
class Command(BaseCommand):
    ...
    help = "Seed initial AAAS data: tiers, features, roles, rate limits"
    ...
    def seed_features(self):
        ...
        from admin.aaas.models import AaasFeature
        ...
        for feature_data in features:
            ...
            _, was_created = AaasFeature.objects.update_or_create(
                code=code,
    ...
    def seed_tier_features(self):
        ...
        from admin.aaas.models import AaasFeature, SubscriptionTier, TierFeature
        ...
        features = {f.code: f for f in AaasFeature.objects.all()}
