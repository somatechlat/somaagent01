...
class SomaBrainEventPublisher:
    ...
    @classmethod
    def publish_salience(cls, agent_id: str, tenant_id: str, salience: float, context: dict = None) -> bool:
...
class AgentEventCapture:
    ...
    def complete_act(
        ...
        if salience > 0:
            SomaBrainEventPublisher.publish_salience(
                self.agent_id, self.tenant_id, salience,
    ...
    def queue_memory(self, content: str, memory_type: str = "episodic", metadata: dict = None) -> None:
