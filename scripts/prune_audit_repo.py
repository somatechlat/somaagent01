...
EXCLUDE_PREFIXES = ['node_modules/', '.git/', 'venv/', 'env/', '__pycache__/', 'dist/', 'build/', 'site-packages/', 'tmp/']
...
# 7) Write outputs
OUT_INV.write_text(json.dumps({'generated_at': int(time.time()), 'count': len(inventory), 'inventory': inventory}, indent=2), encoding='utf-8')
