...
SA01_SOMA_TENANT_ID=production
SA01_SOMA_NAMESPACE=somabrain_ns:production
...
Prometheus is the canonical observability sink. Dashboards are generated by scraping the exposed `/metrics` endpoints; no Grafana artifacts remain in this repo.
