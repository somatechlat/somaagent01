...
This module provides the production health logic (Postgres, Redis, Kafka, HTTP targets)
replacing the previous dummy implementation.
"""
...
async def health_check(
    ...
    overall_status = "ok"
    # If authentication is disabled, we still perform the checks to provide
    # accurate system status to the developer/operator.
