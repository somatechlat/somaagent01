...
import '../components/eog-button.js'; // Assuming basic button component exists

@customElement('eog-mode-selection')
export class EogModeSelection extends LitElement {
    static styles = css`
        :host {
            display: flex;
            min-height: 100vh;
...
declare global {
    interface HTMLElementTagNameMap {
        'eog-mode-selection': EogModeSelection;
    }
}
