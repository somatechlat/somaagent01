...
TIMEOUT = float(cfg.env("E2E_HTTP_TIMEOUT", "20") or "20")
POLL_TIMEOUT = float(cfg.env("E2E_POLL_TIMEOUT", "20") or "20")
POLL_INTERVAL = float(cfg.env("E2E_POLL_INTERVAL", "0.5") or "0.5")
TENANT = cfg.env("SA01_SOMA_TENANT_ID", "public") or "public"
EXPECT_MEMORY = (cfg.env("E2E_EXPECT_MEMORY", "0") or "0").lower() in {"1", "true", "yes"}
