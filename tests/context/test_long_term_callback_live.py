...
async def test_long_term_fact_is_recalled():
    ...
    try:
        fact_summary = "Billing API requires OAuth scope https://www.googleapis.com/auth/cloud-billing"
        ...
        assert scope_lower in reply_lower or scope_lower in window_text, (
