...
export class SomaModal extends LitElement {
    ...
    show() {
        this.open = true;
        this.dispatchEvent(new CustomEvent('soma-open', { bubbles: true, composed: true }));
    }

    /** Close the modal */
    close() {
        this.open = false;
        this.dispatchEvent(new CustomEvent('soma-close', { bubbles: true, composed: true }));
    }
}

declare global {
    interface HTMLElementTagNameMap {
        'soma-modal': SomaModal;
    }
}
