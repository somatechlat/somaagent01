...
export class SomaInput extends LitElement {
    static styles = css`
        ...
        input {
            ...
            background: var(--soma-input-bg, rgba(15, 23, 42, 0.8));
            color: var(--soma-text-main, #e2e8f0);
            font-family: var(--soma-font-sans);
        ...
        return html`
            <div class="input-wrapper">
                ${this.label ? html`
                    <label for="input">
                        ${this.label}
                        ${this.required ? html`<span style="color: var(--soma-danger)">*</span>` : ''}
                    </label>
                ` : ''}
    ...
    private _handleInput(e: Event) {
        ...
        this.dispatchEvent(new CustomEvent('soma-input', {
            bubbles: true,
            composed: true,
    ...
    private _handleBlur() {
        ...
        this.dispatchEvent(new CustomEvent('soma-blur', {
            bubbles: true,
            composed: true,
            detail: { value: this.value }
        }));
