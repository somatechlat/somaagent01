...
import '../components/soma-tenant-switcher.js';
import '../components/soma-voice-button.js';
import './soma-chat.js';
import './soma-login.js';
import './soma-memory.js';
import './soma-tools.js';
import './soma-cognitive.js';
import './soma-settings.js';
import './soma-themes.js';
import './soma-admin.js';
import './soma-platform-dashboard.js';
import './soma-tenants.js';
...
export class SomaApp extends LitElement {
    static styles = css`
        ...
        .nav-section-title {
            ...
            padding: 0 var(--soma-spacing-sm, 8px);
        }
        ...
        .sidebar-footer {
            padding: var(--soma-spacing-md, 16px);
            border-top: 1px solid var(--soma-border-color, rgba(255, 255, 255, 0.05));
        }
        ...
        .mode-indicator {
            ...
            align-items: center;
            gap: var(--soma-spacing-sm, 8px);
            padding: var(--soma-spacing-sm, 8px);
            border-radius: var(--soma-radius-md, 8px);
        ...
        .topbar {
            ...
            padding: 0 var(--soma-spacing-lg, 24px);
            border-bottom: 1px solid var(--soma-border-color, rgba(255, 255, 255, 0.05));
            background: var(--soma-surface, rgba(30, 41, 59, 0.85));
        }
        ...
        .menu-toggle {
            ...
            font-size: 20px;
            cursor: pointer;
            padding: var(--soma-spacing-xs, 4px);
        }
            ...
            <main class="main">
                <header class="topbar">
                    ...
                    <div class="topbar-actions">
                        <soma-voice-button></soma-voice-button>
    ...
    firstUpdated() {
        ...
        if (outlet) {
            ...
            router.setRoutes([
                { path: '/login', component: 'soma-login' },
                { path: '/', redirect: '/chat' },
                { path: '/chat', component: 'soma-chat' },
                { path: '/memory', component: 'soma-memory' },
                { path: '/tools', component: 'soma-tools' },
                { path: '/cognitive', component: 'soma-cognitive' },
                { path: '/settings', component: 'soma-settings' },
                { path: '/themes', component: 'soma-themes' },
                { path: '/admin', component: 'soma-admin' },
                { path: '/platform', component: 'soma-platform-dashboard' },
                { path: '/platform/tenants', component: 'soma-tenants' },
                { path: '(.*)', redirect: '/chat' },
            ]);
