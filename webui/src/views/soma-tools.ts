...
@customElement('soma-tools')
export class SomaTools extends LitElement {
    static styles = css`
        :host {
            display: block;
        ...
        .result-success {
            border: 1px solid var(--soma-success, #22c55e);
        }
        ...
        return html`
            <soma-card class="tool-card">
                ...
                <div class="tool-actions">
                    <soma-button size="small" @click=${() => this._openInvokeModal(tool)}>
                        Invoke
                    </soma-button>
                    <soma-button size="small" variant="secondary" @click=${() => this._viewDetails(tool)}>
                        Details
                    </soma-button>
                </div>
            </soma-card>
    ...
    private _renderInvokeModal() {
        ...
        return html`
            <soma-modal 
                ...
                @soma-close=${() => this._invokeModalOpen = false}
            >
                <div class="param-form">
                    ${this._selectedTool.parameters.map(param => html`
                        <soma-input
                            ...
                            @soma-input=${(e: CustomEvent) => this._invokeParams[param.name] = e.detail.value}
                        ></soma-input>
                    `)}
                </div>
                ...
                <div slot="footer">
                    ...
                    <soma-button variant="secondary" @click=${() => this._invokeModalOpen = false}>
                        Close
                    </soma-button>
                </div>
            </soma-modal>
