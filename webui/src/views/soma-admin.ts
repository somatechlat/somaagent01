...
@customElement('soma-admin')
export class SomaAdmin extends LitElement {
    static styles = css`
        :host {
            display: block;
        ...
        .metric-value {
            font-size: var(--soma-text-3xl, 30px);
            font-weight: 700;
        ...
        .trend-up { color: var(--soma-success, #22c55e); }
        .trend-down { color: var(--soma-danger, #ef4444); }
        ...
        th, td {
            ...
            text-align: left;
            border-bottom: 1px solid var(--soma-border-color, rgba(255, 255, 255, 0.1));
        }
        ...
        .flag-rollout {
            font-size: var(--soma-text-sm, 13px);
            color: var(--soma-accent, #94a3b8);
            margin-right: var(--soma-spacing-md, 16px);
        }

        .action-btn {
            padding: var(--soma-spacing-xs, 4px) var(--soma-spacing-sm, 8px);
            border-radius: var(--soma-radius-sm, 4px);
        ...
        return html`
            <div class="section">
                <div class="section-header">
                    ...
                    <soma-button size="small" @click=${this._inviteUser}>+ Invite User</soma-button>
                </div>
                <soma-card>
                    <table>
                        <thead>
        ...
        return html`
            <div class="section">
                <div class="section-header">
                    ...
                    <soma-button size="small" variant="secondary" @click=${this._exportLogs}>Export</soma-button>
                </div>
                <soma-card>
                    <table>
                        <thead>
    ...
    private _renderFeatureFlags() {
        return html`
            <div class="section">
                <div class="section-header">
                    <h2>Feature Flags</h2>
                    <soma-button size="small" @click=${this._createFlag}>+ New Flag</soma-button>
                </div>
                <soma-card>
                    ${this._featureFlags.map(flag => html`
                        <div class="flag-row">
                            ...
                            <soma-toggle 
                                ...
                                @soma-change=${(e: CustomEvent) => this._toggleFlag(flag.key, e.detail.checked)}
                            ></soma-toggle>
                        </div>
                    `)}
                </soma-card>
